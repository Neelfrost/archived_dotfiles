...
function! s:gruvbox_material_custom() abort
    ...
    " Floaterm
    " call gruvbox_material#highlight('FloatermBorder', l:palette.bg_blue, l:palette.bg0)
    " Lsp
    call gruvbox_material#highlight('Normalfloat', l:palette.blue, l:palette.bg0)
    call gruvbox_material#highlight('Floatborder', l:palette.blue, l:palette.bg0)
    " Spell
    call gruvbox_material#highlight('SpellBad', l:palette.red, l:palette.none, 'bold')
endfunction
